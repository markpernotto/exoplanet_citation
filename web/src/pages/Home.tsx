...
const FEATURED_CATEGORIES: Record<string, FeaturedCategory> = {
  ...
  'galactic-tour': {
    ...
    systems: [
      ...
      { name: 'Kepler-186',          representative: 'Kepler-186 f',          tagline: '579 light-years into the Kepler field, near the galactic plane — local stars rearrange, the Milky Way runs in a different direction, and Sol itself shrinks to a faint pinprick if you know where to look.' },
      { name: 'Kepler-22',           representative: 'Kepler-22 b',           tagline: '638 light-years out, the first habitable-zone Kepler confirmation. A noticeably different patch of disk overhead, with Sol shrunk to a mag-11 dot in the opposite half of the sky.' },
      ...
      { name: 'Kepler-452',          representative: 'Kepler-452 b',          tagline: "1,756 light-years deep into the Kepler field. 'Earth's older cousin' around a sun-like star; local stellar patterns reshape dramatically, and Sol fades to mag 13 at the threshold of visibility." },
